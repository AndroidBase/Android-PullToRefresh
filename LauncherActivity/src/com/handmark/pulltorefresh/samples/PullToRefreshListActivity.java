...
public final class PullToRefreshListActivity extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//mPullRefreshListView.getLoadingLayoutProxy().setLoadingDrawable(getResources().getDrawable(R.drawable.android));
		
	//	mPullRefreshListView.setLoadingDrawable(getResources().getDrawable(R.drawable.android));
		mPullRefreshListView
